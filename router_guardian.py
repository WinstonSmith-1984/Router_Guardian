...
# CONFIG & STATE
# =========================
# Version 1.5.9 - Adjusted Sidebar Alignment & Coffee Button
SYSLOG_PORT = 1514
...
<style>
    {stealth_css}
    /* Main dashboard remains lowered */
    .block-container {{ padding-top: 2.5rem !important; }}
    
    /* Sidebar content pushed up by 1cm (approx 1.2rem) */
...
with st.sidebar:
    ...
    # Large Warm Yellow Coffee Button
    st.markdown('''
        <a href="https://paypal.me/conlon1984" target="_blank" style="text-decoration: none;">
            <div class="coffee-btn" style="background-color: #FFCC00; color: #000; padding: 15px; border-radius: 50%; width: 70px; height: 70px; margin: 0 auto; text-align: center; font-size: 2.2rem; display: flex; align-items: center; justify-content: center; box-shadow: 0 6px 12px rgba(0,0,0,0.4); cursor: pointer;">
                ☕
            </div>
        </a>
